...
| Роут | Когда | Что |
|---|---|---|
| `check-workouts` | каждую минуту | напоминания о запланированных тренировках |
| `microcycle-reminders` | каждую минуту | напоминания по дням цикла |
| `subscription-expiry` | раз в час или в день | пуш «подписка скоро закончится» за 3 дня; молчит при paywall `off` |
| `engagement-nudges` | ежедневно | онбординг-дрип, «серия под угрозой», «гантели запылились» |
...
| `parent-digest` | понедельник | дайджест родителям |
