...
export default function CharacteristicsGainModal({
  ...
  return (
    // Оверлей сам по себе скроллится: раньше был flex+items-center без
    // overflow, и на узких/коротких экранах (Galaxy Fold, cover-экран) карточка
    // не влезала — её обрезало сверху и снизу, а пролистнуть было нельзя.
    <div
      ...
      aria-modal="true"
    >
      {/* min-h-full: центрируем, когда контент влезает, и отдаём прокрутку, когда нет */}
      <div
      ...
      >
        <div
          className={`w-full max-w-md rounded-3xl p-4 sm:p-6 shadow-2xl transition-all duration-500 ${
        ...
        >
          ...
          <div className="flex flex-col gap-2.5 mb-4">
            {gainedCharacteristics.map((char) => {
              ...
              return (
                <div
                  key={char.key}
                  className="rounded-2xl p-3 sm:p-3.5 transition-all duration-500"
                  style={{
                ...
                >
                  {/* На 320px (cover-экран Fold) строка «иконка + название + три
                      числа» не помещалась и уезжала за карточку: название теперь
                      сжимается, блок чисел — нет. */}
                  <div className="flex items-center justify-between gap-2 mb-2.5">
                    <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
                      ...
                      <span className="text-white text-sm font-semibold font-overpass truncate">
                        {char.label}
                      </span>
                    </div>
          ...
          {xpEarned > 0 && (
            <div
              className="rounded-2xl p-3 sm:p-4 mb-3 flex items-center justify-between gap-2"
            ...
            >
              <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
                ...
                <span className="text-white text-base font-semibold font-overpass truncate">Опыт</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                {tempoMultiplier > 1 && (
          ...
          {/* Новый потенциал */}
          <div
            className="rounded-2xl p-3 sm:p-4 mb-6 flex items-center justify-between gap-2"
            style={{
          ...
          >
            <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
              ...
              <span className="text-white text-base font-semibold font-overpass truncate">Потенциал</span>
            </div>
            <span className="text-white text-2xl font-black font-overpass tabular-nums shrink-0">
