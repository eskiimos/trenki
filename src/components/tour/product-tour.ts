...
//
// 3 шага продвигаются реальным тапом пользователя (2, 3, 5) — он сам жмёт
// живые элементы и обучается моторно, как и просил владелец.
//
...
export const PRODUCT_TOUR: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Отметь, как себя чувствуешь — ИИ подстроит нагрузку под твой день.',
  },
  {
    id: 'assess-submit',
    route: '/training/assessment',
