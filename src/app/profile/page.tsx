  ...
  return (
    <div className="bg-surface min-h-screen text-white">
      ...
      <div className="px-4 pb-nav max-w-3xl md:mx-auto md:px-8">
        ...
        {/* Баннер «подписка заканчивается» — сразу под характеристиками
            (правка владельца 14.09): раньше стоял ниже наград, и до него
            почти не доскроливали. Для премиума за 3 дня до конца. */}
