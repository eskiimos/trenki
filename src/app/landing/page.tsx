...
const FEATURES = [
  ...
  { screen: 'catalog', w: 280, eyebrow: 'Каталог', title: '60+ видео-занятий под рукой', body: 'Техника, физподготовка, катание и теория — от реальных тренеров. Фильтруй по цели, типу нагрузки и тренеру, добавляй в избранное.', bullets: ['60+ занятий и каталог растёт', 'Поиск по цели и тренеру', 'Разминка · ФП · техника · теория'] },
