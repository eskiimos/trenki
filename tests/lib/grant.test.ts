...
describe('computePremiumUntil — стекинг премиума', () => {
  ...
  it('бессрочный премиум (PREMIUM + null) оплата НЕ укорачивает — остаётся бессрочным (null)', () => {
    // Ревью возвратов: раньше бессрочный превращался в 30 дней, а возврат затем снимал его
